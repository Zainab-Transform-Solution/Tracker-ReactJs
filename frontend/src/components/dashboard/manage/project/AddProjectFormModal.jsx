...
import { Briefcase, X, Upload, XCircle, ChevronDown, Check } from "lucide-react";
...
const AddProjectFormModal = ({
     ...
     // console.log(projectManagers, assistantManagers, qaManagers, teams);
          ...
          <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
               <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col overflow-hidden animate-fade-in-up">
                  ...
                  focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        ...
                                        onChange={(e) => {
                                             onFieldChange("projectManagerId", e.target.value);
                              ...
                              <div className="relative dropdown-container">
                                   ...
                                   <div className="relative">
                                        ...
                                        {dropdownOpen.assistantManagers && (
                                             <div ref={dropdownRefs.assistantManagers} className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                   ...
                                   <div className="mt-1 flex flex-wrap gap-1">
                                        {newProject.assistantManagerIds?.map(id => {
                                             const am = processedAssistantManagers.find(a => a.user_id === id);
                                             return am ? (
                              ...
                              <div className="relative dropdown-container">
                                   ...
                                   <div className="relative">
                                        ...
                                        {dropdownOpen.qaManagers && (
                                             <div ref={dropdownRefs.qaManagers} className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                   ...
                                   <div className="mt-1 flex flex-wrap gap-1">
                                        {newProject.qaManagerIds?.map(id => {
                                             const qa = processedQaManagers.find(q => q.user_id === id);
                                             return qa ? (
                              ...
                              <div className="relative dropdown-container">
                                   ...
                                   <div className="relative">
                                        ...
                                        {dropdownOpen.teams && (
                                             <div ref={dropdownRefs.teams} className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                   ...
                                   <div className="mt-1 flex flex-wrap gap-1">
                                        {newProject.teamIds?.map(id => {
                                             const team = processedTeams.find(t => t.user_id === id);
                                             return team ? (
