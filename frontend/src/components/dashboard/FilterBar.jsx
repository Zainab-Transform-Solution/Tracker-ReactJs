  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* TASK */}
        <div className="relative flex items-center bg-slate-50 rounded-lg border border-slate-200 w-full">
          <Clock className="absolute left-3 w-4 h-4 text-slate-500" />
          <select
            value={selectedTask}
            onChange={(e) => setSelectedTask(e.target.value)}
            className="w-full bg-slate-50 text-slate-700 text-sm font-medium py-2 pl-9 pr-4 rounded-lg outline-none"
          >
            <option value="All">All Tasks</option>
            {allTasks.map((t) => (
        ...
        {/* PREV PERIOD */}
        <div className="relative flex items-center bg-slate-50 rounded-lg border border-slate-200 w-full">
          <Activity className="absolute left-3 w-4 h-4 text-slate-500" />
          <select
            value={comparisonMode}
            onChange={(e) => setComparisonMode(e.target.value)}
            className="w-full bg-slate-50 text-slate-700 text-sm font-medium py-2 pl-9 pr-4 rounded-lg outline-none"
