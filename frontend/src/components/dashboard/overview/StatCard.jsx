...
const StatCard = ({
     ...
     <div
          className={`bg-white p-4 md:p-5 lg:p-6 rounded-xl shadow-sm border min-w-0 
                ${alert ? 'border-red-200 bg-red-50' : 'border-slate-100'} 
                flex flex-col sm:flex-row md:flex-col lg:flex-row items-start sm:items-center md:items-start lg:items-center justify-between gap-4 relative group/card ${className}`}
     >
          {/* Content Container */}
          ...
          <div className={`p-2 sm:p-2.5 md:p-3 rounded-lg flex-shrink-0 self-start sm:self-center md:self-start lg:self-center
